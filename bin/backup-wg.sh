...
rsync --rsh="ssh -p 1183 -i ~/.ssh/hopper" --dry-run --archive --delete-before --verbose --compress --progress --partial --bwlimit=500 ~/Desktop/sync tyler@hopper.wg:/media/hdd/tyler/sync | tee -a ~/Desktop/rsynclog/sync-hopper-log.txt
