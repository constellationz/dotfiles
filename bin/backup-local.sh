...
rsync --rsh="ssh -p 1183 -i ~/.ssh/hopper" --dry-run --archive --delete-before --verbose --compress --progress --partial ~/Desktop/sync tyler@hopper.local:/media/hdd/tyler/sync | tee -a ~/Desktop/rsynclog/sync-hopper-log.txt
