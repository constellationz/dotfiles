...
rsync --rsh="ssh -p 1183 -i ~/.ssh/hopper" --archive --delete-after --exclude=".hist" --verbose --compress --progress --partial ~/sync/ tyler@$dest:/home/$destdir/ | tee -a ~/rsynclog/sync-hopper-log.txt
